...
<div className="mb-4 bg-gray-100 p-4 rounded-lg">
        ...
        <div className="border border-gray-300 rounded-xl bg-gray-50 p-4">
                ...
                <ul className="py-6 flex items-center list-none">
                    <li className="flex items-center lg:me-6 me-4">
                        ...
                        <span className="lg:text-xl">{vehicle.model}</span>
                    </li>
                    <li className="flex items-center lg:me-6 me-4">
                    ...
                    <li className="flex items-center">
                        ...
                        <span className="lg:text-xl">{vehicle.batteryPower}</span>
                    </li>
                </ul>
  ...
  {vehicle.price && `${vehicle.price.currency} ${vehicle.price.value}`}
  {/* Add space after the price value */}
